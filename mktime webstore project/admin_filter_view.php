<?php
    #Set variable to be used for item filter including @ to suppress error message when 'effectType' has not been defined
    ...
    while ( $row = mysqli_fetch_array( $r, MYSQLI_ASSOC ))
        ...
        echo '
            <div class="col-md-4 mx-auto d-flex" style="padding-top: 40px;">
